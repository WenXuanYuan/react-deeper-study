...
import { readFile, writeFile, glob } from './lib/fs.js';
import { locales } from '../src/config';

const GLOB_PATTERN = 'src/**/*.js';
...
// write messages to file in messages
...
// merge fileMessages to messages
...
async function updateMessages(toBuild) {
    ...
    await Promise.all([
        '_default',
        ...locales,
    ].map(locale => mergeToFile(locale, toBuild)));
}
...
async function extractMessages() {
    ...
    // extract file messages to fileMessages object
